...
import { Search, Home, Users, Briefcase, Calendar, MessageSquare, Bell, Grid3x3 } from 'lucide-react';
...
export function TopNavigation() {
  ...
  const handleSearchResultClick = (result) => {
    ...
    if (result.type === 'user') {
      ...
      window.location.href = `/dsuite/unifinder/${result.id}`;
    } else if (result.type === 'job') {
      window.location.href = `/dsuite/careerbridge/${result.id}`;
    }
  };
    ...
    <header className="top-navigation">
      <div className="nav-container">
        <div className="nav-content">
                  ...
                  {isSearching ? (
                    ...
                    <>
                      ...
                      <div className="search-footer">
                        <a href={`/search?q=${encodeURIComponent(searchQuery)}`} className="view-all-link">
                          View all results
                        </a>
                      </div>
                    </>
            ...
            <div className="desktop-search">
              <div className="search-container">
                ...
                <form onSubmit={handleSearchSubmit}>
                  <Input
                    type="text"
                    placeholder="Search for D-Buddies, Universities, Jobs, Events..."
                    value={searchQuery}
                    onChange={handleSearchChange}
                    className="search-input"
                  />
          ...
          {/* Mobile Icons - Alerts and Messages */}
          ...
          <nav className="desktop-nav">
            ...
            <DropdownMenu>
              <DropdownMenu.Trigger asChild>
                <Button variant="ghost" size="sm" className="profile-button">
                  <Avatar 
                    src={user?.avatar_url} 
              ...
              <DropdownMenu.Content align="end" className="profile-dropdown">
                ...
                <DropdownMenu.Item onClick={() => window.location.href = '/achievements'}>
                  Achievements
                </DropdownMenu.Item>
                <DropdownMenu.Item onClick={() => window.location.href = '/progress'}>
